...
<div class="doc-content">
  ...
  <div class="doc-section">
    <h2 class="doc-title" id="styling-class-toggle" t-html="docs.styling.classToggle.title"></h2>
...
<span class="hl-tag">&lt;/div&gt;</span></pre></div>
    ...
    <h3 class="doc-title" id="styling-class-multi-object" t="docs.styling.classToggle.multiObject"></h3>
    ...
    <h3 class="doc-title" id="styling-class-from-array" t="docs.styling.classToggle.fromArray"></h3>
  ...
  <!-- style-* -->
  <div class="doc-section">
    <h2 class="doc-title" id="styling-inline-styles" t-html="docs.styling.inlineStyles.title"></h2>
...
<span class="hl-tag">&lt;/div&gt;</span></pre></div>
    ...
    <h3 class="doc-title" id="styling-inline-from-object" t="docs.styling.inlineStyles.fromObject"></h3>
